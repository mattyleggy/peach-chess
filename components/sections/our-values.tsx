    ...
    return (
        <Section variant="light" className="space-y-12">
            <div className="text-center space-y-6">
                ...
                <Typography variant="h2">What Drives Us Forward</Typography>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <FeatureCard
                    ...
                    title="Excellence"
                >
                    We strive for excellence in every project, ensuring your website not only looks
                ...
                <FeatureCard
                    ...
                    title="Trust"
                >
                    Building lasting relationships through transparency, reliability, and consistent
