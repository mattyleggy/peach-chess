    ...
    "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
    {
        variants: {
            variant: {
                ...
                secondary: "bg-secondary border border-[2px] border-secondary  text-secondary-foreground shadow-sm hover:bg-secondary/80",
                dropShadow:
                    "bg-primary text-primary-foreground shadow-sm hover:bg-primary/90 drop-shadow-button",
                ghost: "hover:bg-accent hover:text-accent-foreground",
                link: "text-primary underline-offset-4 hover:underline",
            },
            size: {
                default: "h-9 rounded-lg px-8 py-6",
                sm: "h-8 rounded-full px-3 text-xs",
                lg: "h-10 rounded-full px-8",
                icon: "h-9 rounded-full w-9",
            },
        },
        defaultVariants: {
            variant: "default",
